...
//Toast.makeText(Menu_Page.this, "name "+name1+"  dist "+dis1+"  price "+price1, Toast.LENGTH_SHORT).show();
                ...
                Menu_Adapter adpt= new Menu_Adapter(Menu_Page.this, sortedDates);
            ...
            else
            {
                ...
                Menu_Adapter adpt = new Menu_Adapter(Menu_Page.this,options);
                rcView.setAdapter(adpt);
    ...
    ValueEventListener mValueEventListenererev=new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            if(snapshot.exists()) {
                ...
                Menu_Adapter adpt = new Menu_Adapter(Menu_Page.this,sortedDatesDescending);
                rcView.setAdapter(adpt);
