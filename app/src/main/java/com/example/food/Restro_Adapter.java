...
public class Restro_Adapter extends RecyclerView.Adapter<Restro_Adapter.MyViewHolder>{
    Activity context;
    List<DataModal> list;
    static DataModal datamodelTORate;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            restro_name=itemView.findViewById(R.id.rate_name);
            restro_address=itemView.findViewById(R.id.rate_address);
            restro_rating=itemView.findViewById(R.id.rate_rating);
            restro_time=itemView.findViewById(R.id.rate_time);
            restro_description=itemView.findViewById(R.id.rate_description);
            restro_image=itemView.findViewById(R.id.rate_image);
